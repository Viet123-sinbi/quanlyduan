...
public class exercise6 extends javax.swing.JFrame {
    ...
    private void btnnhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnnhapActionPerformed
        exercise.exercise6 hk = new exercise.exercise6();
        hk.setDiachi(txtdiachi.getText());
        hk.setGioitinh(txtgioitinh.getText());
        hk.setHoten(txthoten.getText());
        hk.setTuoi(Integer.parseInt(txttuoi.getText()));
        SimpleDateFormat df = new SimpleDateFormat("dd-MM-yyyy", Locale.ENGLISH);
        Date ngay= txtngaysinh.getDate();
        String text = hk.getHoten()+"\n" + hk.getDiachi() + "\n"+
                 hk.getGioitinh() + "\n"+ hk.getTuoi() + "\n"+ df.format(ngay);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(exercise6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
